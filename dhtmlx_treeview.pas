...
type
  ...
  TDHTMLXTreeview = class external name 'dhtmlXTreeView' (TJSElement)
    ...
    procedure clearAll;	                                                        //removes all the loaded items from TreeView and repaints the component
    ...
    procedure enableDragAndDrop;	                                        //enables drag-n-drop in TreeView
    procedure enableMultiselect;                                                //allows selecting multiple items in TreeView
    //getAllChecked	returns an array of checked items' ids
    //getAllUnchecked	returns an array of unchecked items' ids
    function getItemText(id : JSValue) : string;	                        //returns the item's text
    //getLevel	returns the level index of the specified item
    //getParentId	returns the item's parent id
    function getSelectedId: JSValue;       	                                //returns the selected item's id
    ...
    procedure setIconColor(id : JSValue;color : string);	                //sets a color for the item's icon, if Font Awesome is used
    ...
    procedure silent(event : JSValue);	                                        //calls treeview function w/o triggering events
